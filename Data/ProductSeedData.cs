    ...
    public static IReadOnlyList<Product> All { get; } =
        new List<Product>
        {
                ...
                new Product
                {
                    ...
                    ProductType = ProductType.BeddingSet,
                    Season = ProductSeason.Spring,
                    Material = ProductMaterial.Cotton,
                ...
                new Product
                {
                    ...
                    ProductType = ProductType.BeddingSet,
                    Season = ProductSeason.Summer,
                    Material = ProductMaterial.TencelCotton,
                ...
                new Product
                {
                    ...
                    ProductType = ProductType.Quilt,
                    Season = ProductSeason.Winter,
                    Material = ProductMaterial.GooseDown,
                 ...
                 new Product
                {
                    ...
                    Price = 39.00m,
                    Currency = CurrencyCode.USD,
                    ProductType = ProductType.Pillow,
                    Season = ProductSeason.Winter,
                    Material = ProductMaterial.FiberBlend,
                 ...
                 new Product
                {
                    ...
                    ProductType = ProductType.Pillow,
                    Season = ProductSeason.Autumn,
                    Material = ProductMaterial.Buckwheat,
                 ...
                 new Product
                {
                    ...
                    Price = 59.00m,
                    Currency = CurrencyCode.USD,
                    ProductType = ProductType.Mattress,
                    Season = ProductSeason.Spring,
                    Material = ProductMaterial.Cotton,
                 ...
                 new Product
                {
                    ...
                    ProductType = ProductType.Pillow,
                    Season = ProductSeason.Spring,
                    Material = ProductMaterial.MemoryFoam,
                 ...
                 new Product
                {
                    ...
                    ProductType = ProductType.Mattress,
                    Season = ProductSeason.Autumn,
                    Material = ProductMaterial.BambooCharcoal,
